...
public class HFRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int TYPE_FOOTER_VIEW = Integer.MIN_VALUE + 10;
    ...
    public HFRecyclerAdapter(RecyclerView.Adapter innerAdapter) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType < TYPE_FOOTER_VIEW) {
        ...
        } else if (viewType >= TYPE_FOOTER_VIEW && viewType < TYPE_FOOTER_VIEW + 10) {
            ...
            itemView.setTag(R.id.hfrecycler_item_tag, this);
            return viewHolder;
        }
    }
